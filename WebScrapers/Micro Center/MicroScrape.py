...
vid_content[date.strftime("%x")] = vid_content["Name"].map(vid_card)
...
vid_content.to_csv(r"C:/Python Stuff/WebScrapers/Micro Center/Data/vid_pricing.csv", index = False)
