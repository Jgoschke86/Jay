...
print("Comparing website to data and getting information for processors")
...
print("Comparing website to data and getting information for video cards")
...
print("Executing processor price comparison file")
