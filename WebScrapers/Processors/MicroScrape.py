...
print(amd_content)
print(intel_content)
amd_content.to_csv("C:/Python Stuff/Jay/WebScrapers/Processors/amd_pricing.csv",index = False)
intel_content.to_csv("C:/Python Stuff/Jay/WebScrapers/Processors/intel_pricing.csv", index = False)


exec(open("C:/Python Stuff/Jay/WebScrapers/Processors/Proc_Price_analyze.py").read())