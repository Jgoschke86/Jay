...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__wilma

#else
#  define SWIG_init    init_wilma

#endif
#define SWIG_name    "_wilma"
...
SWIGINTERN PyObject *_wrap_get_skit(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:get_skit",&obj0)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "get_skit" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = (int)(val1);
  result = (char *)get_skit(arg1);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"get_skit", _wrap_get_skit, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
