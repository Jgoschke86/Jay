...
manufacturers = ["Briggs", "Exmark", "Honda", "Kawasaki",
                 "Kohler", "Kubota", "MTD", "Scag", "Stihl", "Toro"]
manufacturers.sort()
num = 1
...
def execute(evt):
    driver = webdriver.Chrome(
        executable_path=r"C:\Users\jgoschke\Downloads\chromedriver.exe")
...
def about_window():
    ...
    back_button = tk.Button(
        top, text="Back", command=top.destroy, width=15, font=16, bg="dark gray")
    back_button.pack()
    top.mainloop()
